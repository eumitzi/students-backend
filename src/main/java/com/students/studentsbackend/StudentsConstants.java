...
public class StudentsConstants {
  ...
  public static String INSERT_INTO_AN_STUDIU =
      "INSERT INTO an_studiu(id_an_studiu, an_studiu, data_inceput, data_sfarsit, id_an_universitar) VALUES (?,?,?,?,?)";
  ...
  public static String INSERT_INTO_PROGRAME_STUDIU =
      "INSERT INTO programe_studiu(id_programe_studiu, detaliu_program_studiu) VALUES (?,?)";
  ...
  public static String INSERT_INTO_INSTANTA_DISCIPLINA =
      "INSERT INTO instanta_disciplina(id_instanta_disciplina, id_disciplina, id_an_studiu, id_an_universitar, numar_credite, semestru, id_student, factor_k) VALUES (?,?,?,?,?,?,?,?)";
  ...
  public static String INSERT_INTO_PERIOADA_SEMESTRU =
      "INSERT INTO perioada_semestru(id_perioada_sem, numar_semestru, data_inceput, data_sfarsit) VALUES (?,?,?,?)";
